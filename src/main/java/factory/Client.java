...
import factory.simple.FangBianMian;
import factory.simple.LaMian;
import factory.simple.Noodles;
...
//          1。简单工厂设计
            Noodles noodles = NoodlesFactory.create(FangBianMian.class);
            noodles.desc();
            Noodles noodles1 = NoodlesFactory.create(LaMian.class);
            noodles1.desc();
//            2.工厂方法设计，关注一类型产品
